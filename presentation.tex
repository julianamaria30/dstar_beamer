...
%*-------------------------------------------------------------------------------
\title              {APEREA}
\subtitle           {Jetbot project}
\author             {Juliana Santana \& Matheus Anselmo}
\email              {juliana.maria@fbter.org.br \& matheus.anselmo@fbter.org.br}
...
\begin{frame}[c,plain]
    \lastpage{
        \begin{center}   
            ...
            %\hspace{1.5cm} 
            juliana.maria@fbter.org.br  matheus.anselmo@fbter.org.br
        \end{center}
    }
